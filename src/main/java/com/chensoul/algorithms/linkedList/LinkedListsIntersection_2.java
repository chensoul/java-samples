...
public class LinkedListsIntersection_2 {
  ...
  public static void main(String[] args) {
    ...
    Node list1node1 = linkedListsIntersection.new Node(1);
    Node list1node2 = linkedListsIntersection.new Node(2);
    Node list1node3 = linkedListsIntersection.new Node(3);
    Node list2node1 = linkedListsIntersection.new Node(4);

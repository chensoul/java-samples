package com.chensoul.algorithms.linkedList;
...
public class MergeSortedLinkedLists {
  ...
  public static void main(String[] args) {
    ...
    Node list1node1 = mergeSortedLinkedLists.new Node(1);
    Node list1node2 = mergeSortedLinkedLists.new Node(3);
    Node list1node3 = mergeSortedLinkedLists.new Node(5);
    Node list2node1 = mergeSortedLinkedLists.new Node(2);
    Node list2node2 = mergeSortedLinkedLists.new Node(4);
    Node list2node3 = mergeSortedLinkedLists.new Node(6);
